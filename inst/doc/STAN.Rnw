...
gvizViterbi_poilog = viterbi2Gviz(viterbi_poilog_gm12878, "chr11", "hg19", from, to, 
        statecols_poilog)
gvizData = data2Gviz(trainRegions[3], pilot.hg19[3], 200, "hg19", col="black", chrom = "chr11")
@
\vspace{0.25cm}
...
gvizData_yeast = data2Gviz(yeastTF_databychrom_ex, yeastGRanges, 8, "sacCer3", col="black", chrom = chr)
gaxis = GenomeAxisTrack()
